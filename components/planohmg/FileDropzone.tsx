...
export default function FileDropzone(props: Props) {
  ...
  if (!file)
    return (
      <label
        htmlFor={name}
        className="border-primary mx-auto flex w-full max-w-lg cursor-pointer flex-col items-center rounded-xl border-2 border-dashed bg-white p-6 text-center dark:bg-zinc-800"
